...
/*****************************************/
data final3;set final3;rename pb=PB ln_mv=SIZE avgTurnoverRate=TurnoverRate asseTLiabRatio=Leverage;run;
/*控制变量回归*/
proc glm data=final3;class industry1 year;
...
data final;merge  final3(in=a) a2(rename=(_col0=code _col3=year));if a ;run;

/**********************************************************/
proc univariate data=final noprint;  *//查找5％、95％;
   var synch _rsq_ holdpct_1st holdpct lq size TurnoverRate Leverage pb ;
   output out=temp p5=synch_1 _rsq__1 holdpct_1st_1 holdpct_1 lq_1 size_1 TurnoverRate_1 Leverage_1 pb_1 
	p95=synch_2 _rsq__2 holdpct_1st_2 holdpct_2 lq_2 size_2 TurnoverRate_2 Leverage_2 pb_2;
run;
